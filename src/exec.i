...
case opc_mov1: NEXT(3, 0, ip->mov.dst < ip->mov.src ? -ip->mov.dst : -ip->mov.src) {
#ifdef EXEC
	SP(ip->mov.dst, u32) = SP(ip->mov.src, u32);
#endif
break;
}
case opc_mov2: NEXT(3, 0, ip->mov.dst < ip->mov.src ? -ip->mov.dst : -ip->mov.src) {
#ifdef EXEC
	SP(ip->mov.dst, u64) = SP(ip->mov.src, u64);
#endif
break;
}
...
//#}
//#{ 0x3?: u32		// uint32
case u32_cmt: NEXT(1, -0, 1) {
#if defined(EXEC)
	SP(0, u32) = ~SP(0, u32);
#endif
	break;
}
case u32_and: NEXT(1, -1, 2) {
#if defined(EXEC)
	SP(1, u32) &= SP(0, u32);
#endif
	break;
}
case u32_ior: NEXT(1, -1, 2) {
#if defined(EXEC)
	SP(1, u32) |= SP(0, u32);
#endif
	break;
...
case u32_shl: NEXT(1, -1, 2) {
#if defined(EXEC)
	SP(1, u32) <<= SP(0, u32);
#endif
	break;
}
case u32_shr: NEXT(1, -1, 2) {
#if defined(EXEC)
	SP(1, u32) >>= SP(0, u32);
#endif
	break;
}
case u32_sar: NEXT(1, -1, 2) {
#if defined(EXEC)
	SP(1, i32) >>= SP(0, i32);
#endif
	break;
...
case u32_bit: NEXT(2, -0, 1) {
#if defined(EXEC)
	switch (ip->idx & 0xC0) {
		case u32_bit_and: SP(0, u32) &= (1 << (ip->idx & 0x3f)) - 1; break;
		case u32_bit_shl: SP(0, u32) <<= ip->idx & 0x3f; break;
		case u32_bit_shr: SP(0, u32) >>= ip->idx & 0x3f; break;
		case u32_bit_sar: SP(0, i32) >>= ip->idx & 0x3f; break;
...
//#}
//#{ 0x3?: U32		// uint32
case u64_cmt: NEXT(1, -0, 2) {
#if defined(EXEC)
	SP(0, u64) = ~SP(0, u64);
#endif
	break;
}
case u64_and: NEXT(1, -2, 4) {
#if defined(EXEC)
	SP(2, u64) &= SP(0, u64);
#endif
	break;
}
case u64_ior: NEXT(1, -2, 4) {
#if defined(EXEC)
	SP(2, u64) |= SP(0, u64);
#endif
	break;
...
case u64_shl: NEXT(1, -1, 3) {
#if defined(EXEC)
	SP(1, u64) <<= SP(0, u32);
#endif
	break;
}
case u64_shr: NEXT(1, -1, 3) {
#if defined(EXEC)
	SP(1, u64) >>= SP(0, u32);
#endif
	break;
}
case u64_sar: NEXT(1, -1, 3) {
#if defined(EXEC)
	SP(1, i64) >>= SP(0, i32);
#endif
	break;

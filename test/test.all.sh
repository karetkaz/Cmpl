...
$CMPL_BIN/cmpl -X-stdin+steps -profile/t/P/G/M -api/A/m/d/p/u -asm/g/n/s -ast/t -doc -log/15 "extras/test.prof.ci" -dump "extras/test.prof.ci" -stdlib/stdlib.ci "test/test.ci"

# dump profile data in json format
$CMPL_BIN/cmpl -X-stdin-steps -profile/t/P/G/M -api/A/m/d/p/u -asm/g/n/s -ast/t -doc -dump.json "extras/test.prof.json" -stdlib/stdlib.ci "test/test.ci"
